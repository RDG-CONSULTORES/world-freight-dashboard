...
<body>
    ...
    <div class="container">
        <header class="header">
            ...
            <div class="status-badge">
                ...
                Demo Preview - Enterprise Ready
            </div>
        </header>

        <div class="warning-box">
            <strong>⚠️ Instalación Requerida:</strong> Para ejecutar el dashboard completo, se necesita resolver los permisos de npm e instalar las dependencias.
        </div>
        ...
        <div class="demo-grid">
            ...
            <div class="demo-card">
                ...
                <p class="card-description">
                    Visualización mundial con rutas comerciales animadas y marcadores de aeropuertos
                </p>
                <ul class="feature-list">
            ...
            <div class="demo-card">
                ...
                <p class="card-description">
                    Monitoreo de servicios de clasificación aduanera con inteligencia artificial
                </p>
                <ul class="feature-list">
            ...
            <div class="demo-card">
                ...
                <p class="card-description">
                    Sistema de análisis y optimización de rutas comerciales con métricas avanzadas
                </p>
                <ul class="feature-list">
            ...
            <div class="demo-card">
                <h3 class="card-title">⚡ Características Técnicas</h3>
                <p class="card-description">
                    Especificaciones técnicas y rendimiento empresarial
                </p>
                <ul class="feature-list">
                    ...
                    <li><span class="check-icon">✓</span> 90%+ Completado</li>
                </ul>
            </div>
            ...
            <div class="demo-card">
                ...
                <p class="card-description">
                    Progreso actual y componentes listos para producción
                </p>
                <ul class="feature-list">
    ...
    <script>
        ...
        console.log('Status: Enterprise Ready - 90% Complete');
        console.log('Next: Resolve npm permissions and run full dashboard');
    </script>
</body>
</html>
`;
...
const server = http.createServer((req, res) => {
  ...
  res.end('<h1>404 Not Found</h1><p>Return to <a href="/">World Freight Dashboard</a></p>');
});

const PORT = 3000;
server.listen(PORT, () => {
  console.log('\n🌍✈️ World Freight Dashboard Preview Server');
  console.log('===============================================');
